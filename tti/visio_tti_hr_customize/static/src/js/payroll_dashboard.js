...
import { PayrollDashboardChecklist } from "./payroll_checklist";
import { Component, onWillStart } from "@odoo/owl";
import { standardActionServiceProps } from "@web/webclient/actions/action_service";

class ExtendedPayrollDashboardComponent extends Component {
    ...
    static components = {
        ...
        PayrollDashboardChecklist,  // Add our custom component
    };
...
// Replace the original dashboard with our extended version
registry.category('actions').add('hr_payroll_dashboard', ExtendedPayrollDashboardComponent, { force: true });