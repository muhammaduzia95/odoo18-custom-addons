...
class EobiMaktabReport(models.AbstractModel):
    _name = "report.visio_payroll_customization.eobi_maktaba_report_template"
    _description = "EOBI Maktaba Report"
