# D:\Visiomate\Odoo\odoo18\custom_addons\eme\visio_eme_custom_invoice\models\eme_proforma_service_pdf.py
from odoo import models, api
from num2words import num2words


class EMEProformaServicePDF(models.AbstractModel):
    _name = 'report.visio_eme_custom_invoice.proforma_invoice_service_pdf'
    _description = 'EME Proforma Invoice (Service) PDF Report'
